...
//	Typedefs
////////////////////////////////////////////////////////////////
typedef bool (CALLBACK *DEFAULT_DLG_CMD_HANDLER) (DialogBaseClass *dialog, int ctrl_id, int mesage_id, LPARAM param);
...
public:
	...
	//	Notifications
	//
	virtual void			On_Command (int ctrl_id, int mesage_id, LPARAM param);
